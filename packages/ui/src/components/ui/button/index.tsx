...
import { ActivityIndicator, Pressable, Text, View } from '../../../rn-primitives';
import { UIIcon } from '@gluestack-ui/core/icon/creator';
const SCOPE = 'BUTTON';
const Root = cssInterop(withStyleContext(Pressable, SCOPE), { className: 'style' });
const UIButton = createButton({
  Root: Root,
  Text: cssInterop(Text, { className: 'style' }),
  Group: cssInterop(View, { className: 'style' }),
...
>(({ className, size: spinnerSize, ...props }, ref) => {
